...
class ProbCover:
    def __init__(self, cfg, lSet, uSet, budgetSize, delta, clip_selection, text_embeddings=None):
        self.cfg = cfg
        ...
        self.counts=self.get_image_counts(self.text_embeddings, self.rel_features)
        ...
        for i in range(self.budgetSize):
            ...
            if self.clip_selection==True:
                ...
                while(check):
                    ...
                    if self.cfg.count_class[0][int(class_idx[0])]<=self.thresold:
